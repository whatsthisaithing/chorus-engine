...
:smoke
echo Running: %PYTHON_CMD% -m pytest -q testing\test_ens_slice01_integration.py testing\test_ens_slice2_integration.py testing\test_ens_slice2_media_refinements_integration.py testing\test_ens_slice25_media_gating_integration.py
%PYTHON_CMD% -m pytest -q testing\test_ens_slice01_integration.py testing\test_ens_slice2_integration.py testing\test_ens_slice2_media_refinements_integration.py testing\test_ens_slice25_media_gating_integration.py
goto :done
